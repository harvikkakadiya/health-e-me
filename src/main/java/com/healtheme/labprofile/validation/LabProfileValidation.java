...
@Component("labpProfileValidation")
public class LabProfileValidation implements LabProfileValidationDAO {
	...
	public String validateLabProfile(LabProfileModel labObj) {
		...
		String errorMessage = errorLabName + errorFirstName + errorMiddleName + errorLastName + errorDob + errorPhone
				...
				+ errorLabLicense + errorAccountName + errorAccountNumber + errorBankNumber + errorTransitNumber;
