...
@Component("patientProfileValidation")
public class PatientProfileValidation implements PatientProfileValidationDAO {
	...
	public String checkValidation(PatientProfileModel patient) {
		...
		String errorMessage = nameMessage + dateMessage + genderMessage + phoneNoMessage + bloodGroupMessage
				+ apartmentNumberMessage + streetMessage + cityMessage + provinceMessage + countryMessage
				+ postalCodeMessage + accountNameMessage + accountNumberMessage + bankNumberMessage
				+ transitNumberMessage;
		return errorMessage;
	}
