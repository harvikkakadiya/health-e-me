...
@Component("doctorSignupValidation")
public class DoctorSignupValidation implements DoctorSignupValidationDAO {
	...
	public String validateDoctorSignup(DoctorSignupModel doctorObj) {
		...
		String errorEmail = isEmailValid(doctorObj.getDoctorEmail());
		String errorPassword = isPasswordValid(doctorObj.getDoctorPassword());
		String errorConfirmPassword = isConfirmPasswordValid(doctorObj.getDoctorPassword(),
				doctorObj.getDoctorConfirmPassword());
		...
		String errorMessage = errorFirstName + errorMiddleName + errorLastName + errorDob + errorGender + errorPhone
				+ errorEmail + errorPassword + errorConfirmPassword + errorApartment + errorStreet + errorCity
				+ errorProvince + errorCountry + errorPostal + errorlQualification + errorSpecialisation
				+ errorDoctorLicense + errorFees + errorAccountName + errorAccountNumber + errorBankNumber
				+ errorTransitNumber;
	...
	public String isConfirmPasswordValid(String password, String confirmPassword) {
		boolean boolValidConfirmPassword = false;
		
		if (password.equals(confirmPassword)) {
			boolValidConfirmPassword = true;
		}
		if (boolValidConfirmPassword) {
			return "";
		}
